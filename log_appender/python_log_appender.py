...
kafka_handler_obj = KafkaLoggingHandler(KAFKA_BOOTSTRAP_SERVER, # decide which Kafka server(s) to append to
                                        TOPIC, # decide which queue to append to
                                        key=SERVICE_NAME, # decide which partition to go to
                                        additional_fields={"service": SERVICE_NAME, "team":TEAM_ID} # additional information to be logged
                                        )
