...
type Log struct {
	Timestamp string `form:"text" json:"timestamp"`
	Level     string `form:"text" json:"levelname"`
	Message   string `form:"text" json:"message"`
	Filename  string `form:"text" json:"filename"`
}
...
func createLog(c *fiber.Ctx) error {
	...
	// _, err := json.Marshal(cmt)
	cmtInBytes, err := json.Marshal(cmt)
	PushLogToQueue("Eventarc", cmtInBytes) // TODO un-comment
